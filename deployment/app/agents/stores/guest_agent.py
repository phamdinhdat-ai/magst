...
class GuestAgent(Agent):
    ...
    def __init__(self, llm: BaseChatModel, default_tool_names: List[str] = None, **kwargs):
        ...
        """
        agent_name = "GuestAgent"
        system_prompt = agent_config['guest_agent']['description']
...
if __name__ == "__main__":
    async def main():
        ...
        # Khởi tạo agent.
        # Với GuestAgent, chúng ta có thể quyết định rằng không có tool mặc định nào.
        # Tool sẽ được chọn hoàn toàn dựa trên `intent` từ EntryAgent.
        guest_agent = GuestAgent(llm=llm)
        ...
        async for partial_state in guest_agent.astream_execute(state_search):
        ...
        async for partial_state_2 in guest_agent.astream_execute(state_chitchat):
