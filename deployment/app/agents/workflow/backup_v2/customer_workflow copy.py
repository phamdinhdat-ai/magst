...
class CustomerWorkflow:
    ...
    def __init__(self, max_iterations: int = 2):
        ...
        self.chat_history_threshold = 6  # Số lượng tin nhắn tối đa trước khi cần tóm tắt
    ...
    def _initialize_agents(self) -> Dict[str, Any]:
        ...
        supervisor_agent = SupervisorAgent(llm=llm) # Supervisor không cn tool
    ...
    def _route_after_context_guardrail(self, state: AgentState) -> str:
        ...
        # Supervisor will use the default "can't answer" response set by the guardrail.
    ...
    async def _run_agent(self, state: AgentState) -> AgentState:
        ...
        if hasattr(agent_to_run, 'cleanup_connections') and callable(agent_to_run.cleanup_connections):
            ...
            time_end = time.time()
            logger.info(f"Agent {agent_name} cleanup took {time_end - time_start:.2f} seconds.")
        return result_state
