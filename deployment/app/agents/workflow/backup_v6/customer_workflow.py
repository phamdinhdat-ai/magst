...
class CustomerWorkflow:
    ...
    def _initialize_agents(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "FallbackAgent": NaiveAgent(llm=llm), # NaiveAgent serves as our fallback
            "DirectAnswerAgent": NaiveAgent(llm=llm), # Can also use a simple LLM chain
                ...
                try:
                    ...
                    # Handle direct LLM streaming events - these are the raw token-by-token chunks
                        ...
                        if chunk_text and isinstance(chunk_text, str):
                            logger.debug(f"LLM stream chunk: {chunk_text[:30]}...")
                        ...
                        if node_name == "final_answer":
                            try:
                                ...
                                if final_answer and final_answer != full_answer:
                                    logger.info("Final answer differs from streamed content, sending final chunk")
